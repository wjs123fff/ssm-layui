           ...
           <!--  <td class="td-status">
            ...
            <td class="td-manage">
             <!--  <a onclick="member_stop(this,'10001')" href="javascript:;"  title="启用">
              ...
              <a title="编辑"  href="${ctx}/job/add?id=${job.id }">
                <i class="layui-icon">&#xe642;</i>
              </a>
...
<div id="pagenum">
        <ul class="pagination">
            <li><a href="${ctx }/job/list?page=1&size=5" aria-label="Previous">首页</a></li>
            <li><a href="${ctx }/job/list?page=${pageInfo.pageNum-1}&size=5">上一页</a></li>
            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNumber">
                <li><a href="${ctx }/job/list?page=${pageNumber}&size=5">${pageNumber}</a></li>
            </c:forEach>
            <li><a href="${ctx }/job/list?page=${pageInfo.pageNum+1}&size=5">下一页</a></li>
            <li><a href="${ctx }/job/list?page=${pageInfo.pages}&size=5" aria-label="Next">尾页</a></li>
        </ul>
</div>
<%--      <div class="page">--%>
<%--        <div>--%>
