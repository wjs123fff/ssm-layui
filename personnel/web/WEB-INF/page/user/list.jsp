...
<%--            <th>注册日期</th>--%>
     ...
     <tr>
        ...
        <div id="pagenum">
        <ul class="pagination">
            <li><a href="${ctx }/user/list?page=1&size=5" aria-label="Previous">首页</a></li>
            <li><a href="${ctx }/user/list?page=${pageInfo.pageNum-1}&size=5">上一页</a></li>
            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNumber">
                <li><a href="${ctx}/notice/list?page=${pageNumber}&size=5">${pageNumber}</a></li>
            </c:forEach>
            <li><a href="${ctx }/user/list?page=${pageInfo.pageNum+1}&size=5">下一页</a></li>
            <li><a href="${ctx }/user/list?page=${pageInfo.pages}&size=5" aria-label="Next">尾页</a></li>
        </ul>
        </div>
...
<%--      </div>--%>
    ...
    <script>var _hmt = _hmt || []; (function() {
        ...
        hm.src = "https://hm.space.bilibili.com//hm.js?b393d153aeb26b46e9431fabaf0f6190";
